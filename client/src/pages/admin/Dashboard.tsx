     ...
     <p className='text-purple font-poppins font-bold text-3xl'>Hello 
      ...
      <form className='border-white bg-white rounded-xl p-4 w-full md:w-3/6 mt-5 '>
        ...
        <div className="flex justify-end ">
          <button className='bg-lightblue text-white font-outfit font-medium text-sm px-5 py-0.5
              rounded-md border font-sm mb-4 border-gray hover:opacity-95 place-self-center	'>Save changes</button>
        </div>
        ...
        <div className='mb-4 flex flex-wrap bg-lightgrey w-full md:w-2/3 rounded-md px-2 py-2 '>
          <div className='w-full'>
            ...
            <p className='text-sm mt-2 mb-3 font-outfit'>change your password here</p>
          </div>
          </div>
        </div>

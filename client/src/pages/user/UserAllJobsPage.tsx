						...
						<label className="relative block ">
							<span className="absolute inset-y-0 left-0 flex items-center pl-2 ">
								<svg
									...
									height="100"
									viewBox="0 0 128 128"
									className="h-8 w-14 fill-slate400"
								>
							...
							<input
								...
								className="mb-2 block w-full rounded-lg border border-slate400  py-2 pl-16 text-md shadow-lg bg-formGrey placeholder:italic placeholder:text-slate400 h-[55px]

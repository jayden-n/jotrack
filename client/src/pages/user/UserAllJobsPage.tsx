						...
						<label className="relative block">
							...
							<span className="absolute inset-y-0 left-0 flex items-center pl-2">
								<svg
									...
									height="100"
									viewBox="0 0 128 128"
									className="h-5 w-10 fill-slate400"
								>
							...
							<input
								...
								className="mb-2 block w-full rounded-lg border border-slate400  py-2 pl-14 text-sm shadow-lg placeholder:italic placeholder:text-slate400 h-[50px]
                                focus:outline-none focus:ring-1 sm:mb-0"
								placeholder="Search for a job title or location..."
								type="text"
								name="search"
							/>
						</label>

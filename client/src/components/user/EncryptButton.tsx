...
const EncryptButton = () => {
	...
	const scramble = () => {
		...
		intervalRef.current = setInterval(() => {
			// randomly mix-up all characters
	...
	return (
		...
		>
			...
			<motion.span
				...
				className="duration-300 absolute inset-0 z-0 scale-125 bg-gradient-to-t from-indigo400/0 from-40% via-indigo400/100 to-indigo400/0 to-60% opacity-0 transition-opacity group-hover:opacity-100"
			/>
		</motion.button>
	);
};
